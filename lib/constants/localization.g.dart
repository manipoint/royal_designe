...
'auth.firstNameFormField': 'First',
'auth.lastNameFormField': 'Last',
...
'home.Account Information':'Account Information',
'home.adminUserLabel': 'Admin User',
'app.title': 'Royale House',
...
'validator.number': 'Please enter phone number.',
...
'auth.firstNameFormField': "D'abord",
'auth.lastNameFormField': 'de famille',
...
'home.phone':'Pas de téléphone',
'home.Account Information':'Information sur le compte',
'home.adminUserLabel': 'utilisateur admin',
'app.title': 'maison royale',
...
'auth.firstNameFormField': 'Primer',
'auth.lastNameFormField': 'apellido', 
...
'home.phone':'Telefono no',
'home.Account Information':'Información de la cuenta',
'app.title': 'Casa real',
...
'auth.nameFormField': 'Name',
'auth.firstNameFormField': 'Eerste',
'auth.lastNameFormField': 'Laatst',  
...
'home.address':'Telefoon nr',
'home.phone':'',
'home.Account Information':'Account Informatie',
'app.title': 'Koninklijk Huis',
...
'ur': {
'auth.signInButton': 'سائن ان بٹن',
'auth.signUpButton': 'سائن اپ بٹن',
'auth.resetPasswordButton': 'پاس ورڈ بٹن کو دوبارہ ترتیب دیں۔',
'auth.emailFormField': 'ای میل',
'auth.passwordFormField': 'پاس ورڈ',
'auth.nameFormField': 'نام',
'auth.firstNameFormField': 'پہلا',
'auth.lastNameFormField': 'آخری',   
'auth.signInErrorTitle': 'غلطی سے سائن ان',
'auth.signInError': 'لاگ ان ناکام: ای میل یا پاس ورڈ غلط ہے۔',
'auth.resetPasswordLabelButton': 'پاسورڈ بھول گے؟',
'auth.signUpLabelButton': 'اکاؤنٹ بنائیں',
'auth.signUpErrorTitle': 'سائن اپ ناکام ہو گیا۔',
'auth.signUpError': 'سائن اپ کرنے میں کوی مسئلہ تھا۔ بعد میں دوبارہ کوشش کریں۔',
'auth.signInLabelButton': 'اکاؤنٹ ہے؟ داخلہ ہو جایں',
'auth.resetPasswordNoticeTitle': 'پاس ورڈ ری سیٹ ای میل بھیجی گئی',
'auth.resetPasswordNotice': 'اپنا ای میل چیک کریں اور اپنا پاس ورڈ دوبارہ ترتیب دینے کے لیے ہدایات پر عمل کریں۔।',
'auth.resetPasswordFailed': 'پاس ورڈ دوبارہ ترتیب دینے والا ای میل ناکام ہو گیا۔',
'auth.signInonResetPasswordLabelButton': 'داخلہ لینا',
'auth.updateUser': 'پروفائل کو اپ ڈیٹ کریں۔',
'auth.updateUserSuccessNoticeTitle': 'صارف کو اپ ڈیٹ کیا',
'auth.updateUserSuccessNotice': 'صارف کی معلومات کو کامیابی کے ساتھ اپ ڈیٹ کر دیا گیا۔',
'auth.updateUserEmailInUse': 'اسں ای میل پتہ پر پہلے سے ہی ایک اکاؤنٹ ہے۔',
'auth.updateUserFailNotice': 'صارف کو اپ ڈیٹ کرنے میں ناکام',
'auth.enterPassword': 'اپنا پاس ورڈ درج کریں',
'auth.cancel': 'منسوخ کریں',
'auth.submit': 'پیش کریں۔',
'auth.changePasswordLabelButton': 'پاس ورڈ تبدیل کریں',
'auth.resetPasswordTitle': 'پاس ورڈ دوبارہ ترتیب دیں',
'auth.updateProfileTitle': 'پروفائل کو اپ ڈیٹ کریں۔',
'auth.wrongPasswordNoticeTitle': 'لاگ ان ناکام رہے',
'auth.wrongPasswordNotice': 'پاس ورڈ ہمارے ریکارڈ سے نہیں ملتا۔',
'auth.unknownError': 'نامعلوم خامی',
'settings.title': 'ایڈجسٹمنٹ',
'settings.language': 'زبان:اردو ۔',
'settings.theme': 'مضمون',
'settings.signOut': 'باہر جانا',
'settings.dark': 'اندھیرا',
'settings.light': 'روشنی',
'settings.system': 'سسٹم',
'settings.updateProfile': 'پروفائل کو اپ ڈیٹ کریں',
'home.title': 'گھر',
'home.nameLabel': 'نام',
'home.uidLabel': 'یوایڈی',
'home.emailLabel': 'ای میل',
'home.adminUserLabel': 'منتظم صارف',
'home.Account Information':'اکاؤنٹ کی معلومات',
'home.address':'پتہ',
'home.phone':'فون نمبر',
'app.title': 'رایل ہاوس',
'validator.email': 'برائے مہربانی قابل قبول ای میل ایڈریس لکھیں.',
'validator.password': 'پاس ورڈ کم از کم 6 حروف کا ہونا چاہیے۔',
'validator.name': 'ایک نام درج کریں۔',
'validator.number': 'براہ کرم اپنا فون نمبر درج کریں۔',
'validator.notEmpty': 'یہ ایک مطلوبہ فیلڈ ہے.',
'validator.amount': 'کوئی بھی ڈالر کی علامت اور کوئی بھی سینٹ - ایک نمبر یعنی 250 درج کریں۔',
},
'hi': {
...
'auth.firstNameFormField': 'प्रथम',
'auth.lastNameFormField': 'अंतिम',    
...
'home.Account Information':'खाता संबंधी जानकारी',
'home.address':'पता',
'home.phone':'फ़ोन नंबर',
'app.title': 'रॉयल हाउस',
...
'auth.firstNameFormField': 'Primeiro',
'auth.lastNameFormField': 'Durar',     
...
'home.emailLabel': 'E-mail',
'home.adminUserLabel': 'admin User',
'home.Account Information':'Informação da conta',
'home.address':'Endereço',
'home.phone':'Número de telefone',
'app.title': 'Royale House',
...
'auth.firstNameFormField': '第一的',
'auth.lastNameFormField': '最后的',   
...
'home.Account Information':'帐户信息',
'home.address':'地址',
'home.phone':'电话号码 电话号码',
'app.title': '皇家之家',
...
'auth.firstNameFormField': '初め',
'auth.lastNameFormField': '最後',   
...
'auth.firstNameFormField': 'Первый',
'auth.lastNameFormField': 'Последний',   
...
'home.Account Information':'ccount Информаци',
'home.address':'Адрес',
'home.phone':'Номер телефона',
'app.title': 'Королевский дом',
